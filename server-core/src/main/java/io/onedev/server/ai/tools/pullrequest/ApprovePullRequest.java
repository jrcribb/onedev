...
public final class ApprovePullRequest implements TaskTool {

	public static final String TOOL_NAME = "approvePullRequest";

	private final long pullRequestId;

	public ApprovePullRequest(long pullRequestId) {
	...
	public ToolSpecification getSpecification() {
		return ToolSpecification.builder()
				.name(TOOL_NAME)
				.description("Record an approval for OneDev pull request. "
	...
	public ToolExecutionResult execute(Subject subject, JsonNode arguments) {
		...
		OneDev.getInstance(PullRequestReviewService.class).review(user, request, true, reason);
